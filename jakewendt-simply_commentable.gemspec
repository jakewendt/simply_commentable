...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/app/controllers/application_controller.rb", "test/app/models/post.rb", "test/app/models/user.rb", "test/factories.rb", "test/unit/commentable/comment_test.rb", "test/unit/post_test.rb", "test/unit/user_test.rb"]
